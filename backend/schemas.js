...
const IntegrationMetadataSchema = z
  ...
  .refine(
    (obj) => {
      ...
      return JSON.stringify(obj).length <= 4096;
    },
    { message: 'integrationMetadata: at most 20 keys; key ≤64 chars; value ≤512 chars; total JSON ≤4096 bytes' }
  );

const IntegrationContextFields = {
  integrationExternalRef: z.string().trim().max(256).optional(),
